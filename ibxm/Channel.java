 ...
 public class Channel {
   ...
   private static final short[] sineTable = new short[] { 0, 24, 49, 74, 97, 120, 141, 161, 180, 197, 212, 224, 235, 244, 250, 253, 255, 253, 250, 244, 235, 224, 212, 197, 180, 161, 141, 120, 97, 74, 49, 24 }; private Module module; private GlobalVol globalVol; private Instrument instrument; private Sample sample; private boolean keyOn;
   private int noteKey;
   private int noteIns;
   private int noteVol;
   ...
   private int tonePortaParam; private int offsetParam; private int finePortaUpParam; private int finePortaDownParam; private int extraFinePortaParam; private int arpeggioParam; private int vslideParam; private int globalVslideParam; private int panningSlideParam; private int fineVslideUpParam; private int fineVslideDownParam; private int retrigVolume; private int retrigTicks; private int tremorOnTicks; private int tremorOffTicks; private int vibratoType; private int vibratoPhase; private int vibratoSpeed; private int vibratoDepth; private int tremoloType; private int tremoloPhase; private int tremoloSpeed; private int tremoloDepth; private int tremoloAdd; private int vibratoAdd; private int arpeggioAdd; private int id; private int randomSeed; public int plRow;
   public void resample(int[] outBuf, int offset, int length, int sampleRate, int interpolation) {
     ...
     switch (interpolation) {
       case 0:
         ...
         return;
       default:
         this.sample.resampleLinear(this.sampleIdx, this.sampleFra, step, lAmpl, rAmpl, outBuf, offset, length); return;
       case 2:
         break;
   ...
   public void row(Note note) {
     ...
     switch (this.noteEffect) { case 1:
       case 134:
         if (this.noteParam > 0) this.portaUpParam = this.noteParam; 
         portamentoUp(this.portaUpParam); break;
       case 2:
       case 133:
         if (this.noteParam > 0) this.portaDownParam = this.noteParam; 
         portamentoDown(this.portaDownParam); break;
       case 3:
       case 135:
         if (this.noteParam > 0) this.tonePortaParam = this.noteParam;  break;
       case 4:
       case 136:
         if (this.noteParam >> 4 > 0) this.vibratoSpeed = this.noteParam >> 4; 
         if ((this.noteParam & 0xF) > 0) this.vibratoDepth = this.noteParam & 0xF; 
         vibrato(false); break;
       case 5:
       case 140:
         if (this.noteParam > 0) this.vslideParam = this.noteParam; 
         volumeSlide(); break;
       case 6:
       case 139:
         if (this.noteParam > 0) this.vslideParam = this.noteParam; 
       ...
       case 7:
       case 146:
         if (this.noteParam >> 4 > 0) this.tremoloSpeed = this.noteParam >> 4; 
         if ((this.noteParam & 0xF) > 0) this.tremoloDepth = this.noteParam & 0xF; 
         tremolo();
         break;
       case 8:
         this.panning = (this.noteParam < 128) ? (this.noteParam << 1) : 255; break;
       case 10:
       case 132:
         if (this.noteParam > 0) this.vslideParam = this.noteParam; 
         volumeSlide();
         break;
       case 12:
         this.volume = (this.noteParam >= 64) ? 64 : (this.noteParam & 0x3F); break;
       case 16:
       case 150:
         this.globalVol.volume = (this.noteParam >= 64) ? 64 : (this.noteParam & 0x3F);
         break;
       case 17:
         if (this.noteParam > 0) this.globalVslideParam = this.noteParam; 
         break;
       case 20:
         this.keyOn = false;
         break;
       case 21:
         ...
         break;
       case 25:
         if (this.noteParam > 0) this.panningSlideParam = this.noteParam;  break;
       case 27:
       case 145:
         if (this.noteParam >> 4 > 0) this.retrigVolume = this.noteParam >> 4; 
         if ((this.noteParam & 0xF) > 0) this.retrigTicks = this.noteParam & 0xF; 
         retrigVolSlide(); break;
       case 29:
       case 137:
         if (this.noteParam >> 4 > 0) this.tremorOnTicks = this.noteParam >> 4; 
         if ((this.noteParam & 0xF) > 0) this.tremorOffTicks = this.noteParam & 0xF; 
         tremor();
         break;
       case 33:
         if (this.noteParam > 0) this.extraFinePortaParam = this.noteParam; 
         switch (this.extraFinePortaParam & 0xF0) {
           case 16:
             portamentoUp(0xE0 | this.extraFinePortaParam & 0xF);
             break;
           case 32:
             portamentoDown(0xE0 | this.extraFinePortaParam & 0xF);
             break;
         } 
         break;
       case 113:
         if (this.noteParam > 0) this.finePortaUpParam = this.noteParam; 
         portamentoUp(0xF0 | this.finePortaUpParam & 0xF);
         break;
       case 114:
         if (this.noteParam > 0) this.finePortaDownParam = this.noteParam; 
         portamentoDown(0xF0 | this.finePortaDownParam & 0xF); break;
       case 116:
       case 243:
         if (this.noteParam < 8) this.vibratoType = this.noteParam;  break;
       case 119:
       case 244:
         if (this.noteParam < 8) this.tremoloType = this.noteParam; 
         break;
       case 122:
         if (this.noteParam > 0) this.fineVslideUpParam = this.noteParam; 
         this.volume += this.fineVslideUpParam;
         if (this.volume > 64) this.volume = 64; 
         break;
       case 123:
         if (this.noteParam > 0) this.fineVslideDownParam = this.noteParam; 
         this.volume -= this.fineVslideDownParam;
         if (this.volume < 0) this.volume = 0;  break;
       case 124:
       case 252:
         if (this.noteParam <= 0) this.volume = 0; 
         break;
       case 138:
         if (this.noteParam > 0) this.arpeggioParam = this.noteParam; 
         break;
       case 149:
         if (this.noteParam >> 4 > 0) this.vibratoSpeed = this.noteParam >> 4; 
         if ((this.noteParam & 0xF) > 0) this.vibratoDepth = this.noteParam & 0xF; 
   ...
   public void tick() {
     ...
     if (this.noteEffect != 125 || this.fxCount > this.noteParam) {
       switch (this.noteVol & 0xF0) {
         ...
         case 208:
           ...
           if (this.panning < 0) this.panning = 0; 
           break;
         case 224:
           this.panning += this.noteVol & 0xF;
           if (this.panning > 255) this.panning = 255; 
           break;
         case 240:
           tonePortamento();
           break;
     ...
     switch (this.noteEffect) { case 1:
       ...
       case 17:
         ...
         if (this.globalVol.volume < 0) this.globalVol.volume = 0; 
         if (this.globalVol.volume > 64) this.globalVol.volume = 64; 
         break;
       case 25:
         this.panning += (this.panningSlideParam >> 4) - (this.panningSlideParam & 0xF);
         if (this.panning < 0) this.panning = 0; 
         if (this.panning > 255) this.panning = 255;  break;
       case 27:
       case 145:
         retrigVolSlide(); break;
       case 29:
       ...
       case 124:
       case 252:
         if (this.noteParam == this.fxCount) this.volume = 0;  break;
       case 125:
       case 253:
         if (this.noteParam == this.fxCount) trigger(); 
         break;
       case 138:
         if (this.fxCount > 2) this.fxCount = 0; 
         if (this.fxCount == 0) this.arpeggioAdd = 0; 
         if (this.fxCount == 1) this.arpeggioAdd = this.arpeggioParam >> 4; 
         if (this.fxCount == 2) this.arpeggioAdd = this.arpeggioParam & 0xF; 
         break;
       case 149:
         this.vibratoPhase += this.vibratoSpeed;
         vibrato(true);
   ...
   private void updateEnvelopes() {
     if (this.instrument.volumeEnvelope.enabled) {
       if (!this.keyOn) {
         ...
         if (this.fadeOutVol < 0) this.fadeOutVol = 0; 
       } 
   ...
   private void autoVibrato() {
     ...
     if (depth > 0) {
       ...
       if (this.autoVibratoCount < sweep) depth = depth * this.autoVibratoCount / sweep; 
       this.vibratoAdd += waveform(this.autoVibratoCount * rate >> 2, type + 4) * depth >> 8;
   ...
   private void volumeSlide() {
     ...
     if (down == 15 && up > 0) {
       if (this.fxCount == 0) this.volume += up; 
     } else if (up == 15 && down > 0) {
       if (this.fxCount == 0) this.volume -= down; 
   ...
   private void portamentoUp(int param) {
     switch (param & 0xF0) {
       case 224:
         if (this.fxCount == 0) this.period -= param & 0xF; 
         break;
       case 240:
         if (this.fxCount == 0) this.period -= (param & 0xF) << 2; 
         break;
       default:
         if (this.fxCount > 0) this.period -= param << 2; 
         break;
     } 
   ...
   private void tonePortamento() {
     if (this.period > 0)
       if (this.period < this.portaPeriod) {
         ...
         if (this.period > this.portaPeriod) this.period = this.portaPeriod; 
       } else {
         this.period -= this.tonePortaParam << 2;
         if (this.period < this.portaPeriod) this.period = this.portaPeriod;
   ...
   private void vibrato(boolean fine) {
     this.vibratoAdd = waveform(this.vibratoPhase, this.vibratoType & 0x3) * this.vibratoDepth >> (fine ? 7 : 5);
   }
   
   private void tremolo() {
     this.tremoloAdd = waveform(this.tremoloPhase, this.tremoloType & 0x3) * this.tremoloDepth >> 6;
   }
   ...
   private int waveform(int phase, int type) {
     ...
     { default:
         ...
         return amplitude;case 6: amplitude = ((phase + 32 & 0x3F) << 3) - 255; return amplitude;case 1: case 7: amplitude = 255 - ((phase + 32 & 0x3F) << 3); return amplitude;case 2: case 5: amplitude = ((phase & 0x20) > 0) ? 255 : -255; return amplitude;case 3: case 8: break; }  amplitude = (this.randomSeed >> 20) - 255; this.randomSeed = this.randomSeed * 65 + 17 & 0x1FFFFFFF; return amplitude;
   }
   
   private void tremor() {
     if (this.retrigCount >= this.tremorOnTicks) this.tremoloAdd = -64; 
   ...
   private void retrigVolSlide() {
     if (this.retrigCount >= this.retrigTicks) {
       ...
       switch (this.retrigVolume) { case 1:
           this.volume--; break;
         case 2: this.volume -= 2; break;
         case 3: this.volume -= 4; break;
         case 4: this.volume -= 8; break;
         case 5: this.volume -= 16; break;
         case 6: this.volume -= this.volume / 3; break;
         case 7: this.volume >>= 1; break;
         case 9:
           this.volume++; break;
         case 10: this.volume += 2; break;
         case 11: this.volume += 4; break;
         case 12: this.volume += 8; break;
         case 13: this.volume += 16; break;
         case 14: this.volume += this.volume >> 1; break;
         case 15: this.volume <<= 1; break; }
   ...
   private void calculateFrequency() {
     if (this.module.linearPeriods) {
       ...
       per = per * (periodTable[(this.arpeggioAdd & 0xF) << 3] << 1) / periodTable[0];
       per = (per >> 1) + (per & 0x1);
   ...
   private void trigger() {
     if (this.noteIns > 0 && this.noteIns <= this.module.numInstruments) {
       ...
       if (sam.panning >= 0) this.panning = sam.panning & 0xFF; 
       if (this.period > 0 && sam.looped()) this.sample = sam; 
       this.sampleOffset = this.volEnvTick = this.panEnvTick = 0;
       this.fadeOutVol = 32768;
       this.keyOn = true;
     } 
     if (this.noteEffect == 9 || this.noteEffect == 143) {
       if (this.noteParam > 0) this.offsetParam = this.noteParam; 
     ...
     switch (this.noteVol & 0xF0) {
       ...
       case 144:
         ...
         break;
       case 160:
         if ((this.noteVol & 0xF) > 0) this.vibratoSpeed = this.noteVol & 0xF; 
         break;
       case 176:
         if ((this.noteVol & 0xF) > 0) this.vibratoDepth = this.noteVol & 0xF; 
         vibrato(false);
         break;
       case 192:
         ...
         break;
       case 240:
         if ((this.noteVol & 0xF) > 0) this.tonePortaParam = this.noteVol & 0xF; 
         break;
     } 
     if (this.noteKey > 0) {
       if (this.noteKey > 96) {
         ...
         boolean isPorta = ((this.noteVol & 0xF0) == 240 || this.noteEffect == 3 || this.noteEffect == 5 || this.noteEffect == 135 || this.noteEffect == 140);
 
         
         if (!isPorta) this.sample = this.instrument.samples[this.instrument.keyToSample[this.noteKey]]; 
